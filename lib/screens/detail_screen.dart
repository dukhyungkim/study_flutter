...
class _DetailScreenState extends State<DetailScreen> {
  ...
  static const keyLikedToons = 'likedToons';

  Future initPrefs() async {
    prefs = await SharedPreferences.getInstance();
    final likedToons = prefs.getStringList(keyLikedToons);
    if (likedToons != null) {
      ...
      prefs.setStringList(keyLikedToons, []);
    }
  }
  ...
  onHeartTap() async {
    ...
    if (likedToons != null) {
      ...
      await prefs.setStringList(keyLikedToons, likedToons);
      setState(() {
        isLiked = !isLiked;
      });
    }
